...
/// PawsApp handles the core chat functionality by orchestrating various
/// services. It encapsulates the complex logic previously contained in the
/// PawsAPI chat method.
pub struct PawsApp<S> {
    services: Arc<S>,
    tool_registry: ToolRegistry<S>,
    authenticator: Authenticator<S>,
}

impl<S: Services> PawsApp<S> {
    /// Creates a new PawsApp instance with the provided services.
    ...
    /// This method contains the core chat logic extracted from PawsAPI.
    pub async fn chat(
        &self,
        agent_id: AgentId,
        chat: ChatRequest,
    ...
    pub async fn compact_conversation(
        ...
        let mut conversation = self
            ...
            .await?
            .ok_or_else(|| paws_domain::Error::ConversationNotFound(*conversation_id))?;
