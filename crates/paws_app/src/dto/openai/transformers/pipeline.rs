use paws_domain::{DefaultTransformation, Provider, ProviderId, Transformer};
use url::Url;
...
mod tests {
    ...
    fn test_supports_open_router_params() {
        assert!(supports_open_router_params(&paws("paws")));
    ...
    fn test_zai_provider_applies_thinking_transformation() {
        ...
        let fixture = Request::default().reasoning(paws_domain::ReasoningConfig {
            enabled: Some(true),
            effort: None,
            max_tokens: None,
            exclude: None,
