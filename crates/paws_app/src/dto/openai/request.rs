...
pub struct Request {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub reasoning: Option<paws_domain::ReasoningConfig>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl From<paws_domain::Role> for Role {
    fn from(role: paws_domain::Role) -> Self {
        match role {
            paws_domain::Role::System => Role::System,
            paws_domain::Role::User => Role::User,
            paws_domain::Role::Assistant => Role::Assistant,
        }
    }
}
...
<task>
    ...
    fn test_context_conversion_stream_defaults_to_true() {
        let fixture = paws_domain::Context::default();
    ...
    fn test_context_conversion_stream_explicit_true() {
        let fixture = paws_domain::Context::default().stream(true);
        let actual = Request::from(fixture);
    ...
    fn test_context_conversion_stream_explicit_false() {
        let fixture = paws_domain::Context::default().stream(false);
        let actual = Request::from(fixture);
