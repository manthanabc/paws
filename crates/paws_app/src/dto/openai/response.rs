...
impl From<ReasoningDetail> for paws_domain::ReasoningDetail {
    fn from(detail: ReasoningDetail) -> Self {
        paws_domain::ReasoningDetail {
            text: detail.text,
...
impl GitHubCopilotReasoning {
    fn into_reasoning_detail(self) -> paws_domain::ReasoningDetail {
        paws_domain::ReasoningDetail {
            text: self.text,
            data: self.data,
            type_of: self.r#type,
...
mod tests {
    use anyhow::Context;
    use paws_domain::ChatCompletionMessage;
