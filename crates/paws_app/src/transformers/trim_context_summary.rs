use paws_domain::{ContextSummary, Role, SummaryMessage, SummaryTool, Transformer};
...
enum Operation<'a> {
    ...
    CodebaseSearch {
        queries: &'a [paws_domain::SearchQuery],
...
#[cfg(test)]
mod tests {
    use paws_domain::{Role, SummaryBlock, SummaryToolCall, ToolCallId};
