...
/// Checks if the Paws VS Code extension is installed
///
/// Checks VS Code's extension list to see if PawsCode.paws-vscode is
/// installed.
pub fn is_extension_installed() -> bool {
        ...
        && let Ok(extensions) = String::from_utf8(output.stdout)
    {
        return extensions
            .lines()
            .any(|line| line.trim() == "PawsCode.paws-vscode");
    }
    false
}

/// Attempts to install the Paws VS Code extension silently
///
