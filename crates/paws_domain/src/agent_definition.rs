...
impl AgentId {
    ...
    pub const FORGE: AgentId = AgentId(Cow::Borrowed("paws"));
    pub const PAWS: AgentId = AgentId(Cow::Borrowed("paws"));
...
pub struct ReasoningConfig {
    ...
    /// supported by openrouter and paws provider
    #[serde(skip_serializing_if = "Option::is_none")]
    pub effort: Option<Effort>,

    /// Controls how many tokens the model can spend thinking.
    /// supported by openrouter, anthropic and paws provider
