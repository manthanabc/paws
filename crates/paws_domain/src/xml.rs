...
mod tests {
    ...
    fn test_extract_tag_names_with_prefix() {
        let fixture = "<paws_tool>Something</paws_tool> <paws_tool_call>Content</paws_tool_call> <other>More</other>";
        ...
        assert!(!actual.contains("<paws_tool>"));
        assert!(!actual.contains("<paws_tool_call>"));
    }
    ...
    fn test_extract_tag_names_with_prefix_duplicates() {
        let fixture =
            "<paws_tool>First</paws_tool><other>Middle</other><paws_tool>Second</paws_tool>";
        let actual = remove_tag_with_prefix(fixture, "paws");
    ...
    fn test_extract_tag_names_with_prefix_attributes() {
        let fixture = "<paws_tool id=\"1\">Content</paws_tool> <paws_tool_call class=\"important\">More</paws_tool_call>";
        let actual = remove_tag_with_prefix(fixture, "paws");
    ...
    fn test_remove_tag_with_prefix() {
        let fixture = "<paws_task>Task details</paws_task> Regular text <paws_analysis>Analysis details</paws_analysis>";
        let actual = remove_tag_with_prefix(fixture, "paws_");
