...
pub struct Environment {
    ...
    /// Base URL for Paws's backend APIs
    #[dummy(expr = "url::Url::parse(\"https://example.com\").unwrap()")]
    pub paws_api_url: Url,
...
impl Environment {
    ...
    pub fn history_path(&self) -> PathBuf {
        self.custom_history_path
            .clone()
            .unwrap_or(self.base_path.join(".paws_history"))
    }
    ...
    /// Returns the global skills directory path (~/paws/skills)
    pub fn global_skills_path(&self) -> PathBuf {
        self.base_path.join("skills")
    }

    /// Returns the project-local skills directory path (.paws/skills)
    pub fn local_skills_path(&self) -> PathBuf {
        self.cwd.join(".paws/skills")
    }
...
mod tests {
    ...
    fn test_agent_cwd_path() {
        ...
        let expected = PathBuf::from("/current/working/dir/.paws/agents");
    ...
    fn test_agent_cwd_path_independent_from_agent_path() {
        ...
        let expected_agent_cwd_path = PathBuf::from("/different/current/dir/.paws/agents");
    ...
    fn test_global_skills_path() {
        let fixture: Environment = Faker.fake();
        let fixture = fixture.base_path(PathBuf::from("/home/user/.paws"));

        let actual = fixture.global_skills_path();
        let expected = PathBuf::from("/home/user/.paws/skills");
    ...
    fn test_local_skills_path() {
        ...
        let expected = PathBuf::from("/projects/my-app/.paws/skills");
    ...
    fn test_skills_paths_independent() {
        ...
        let fixture = fixture
            ...
            .base_path(PathBuf::from("/home/user/.paws"));

        let global_path = fixture.global_skills_path();
        let local_path = fixture.local_skills_path();

        let expected_global = PathBuf::from("/home/user/.paws/skills");
        let expected_local = PathBuf::from("/projects/my-app/.paws/skills");
...
fn test_command_path() {
    let fixture = Environment {
        ...
        shell: "zsh".to_string(),
        base_path: PathBuf::from("/home/user/.paws"),
        paws_api_url: "https://api.example.com".parse().unwrap(),
    ...
    let expected = PathBuf::from("/home/user/.paws/commands");
...
fn test_command_cwd_path() {
    ...
    let expected = PathBuf::from("/current/working/dir/.paws/commands");
...
fn test_command_cwd_path_independent_from_command_path() {
    ...
    let expected_command_cwd_path = PathBuf::from("/different/current/dir/.paws/commands");
