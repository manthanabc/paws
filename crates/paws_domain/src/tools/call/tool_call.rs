...
impl ToolCallId {
    ...
    fn generate() -> Self {
        let id = format!("paws_call_id_{}", uuid::Uuid::new_v4());
        ToolCallId(id)
    }
}
...
impl ToolCallFull {
    ...
    pub fn try_from_xml(input: &str) -> std::result::Result<Vec<ToolCallFull>, Error> {
        match extract_tag_content(input, "paws_tool_call") {
...
mod tests {
    ...
    fn test_multiple_calls() {
        let input = [
            ToolCallPart {
                ...
                arguments_part: "{\"path\": \"crates/paws_services/src/fixtures/".to_string(),
            },
            ToolCallPart {
                call_id: None,
                name: None,
            ...
            ToolCallPart {
                ...
                name: Some(ToolName::new("read")),
                arguments_part: "{\"path\": \"crates/paws_services/src/service/".to_string(),
            },
            ToolCallPart {
                call_id: None,
                name: None,
    ...
    async fn test_try_from_xml_call_id() {
        ...
        assert!(actual.as_str().starts_with("paws_call_id_"));
    }
    #[test]
