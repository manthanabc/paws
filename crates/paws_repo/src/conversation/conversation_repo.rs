...
use diesel::prelude::*;
use paws_domain::{Conversation, ConversationId, ConversationRepository, WorkspaceHash};
...
mod tests {
    ...
    fn test_context_record_conversion_preserves_all_fields() {
        ...
        let reasoning = paws_domain::ReasoningConfig {
        ...
        let messages = vec![
            ...
            .into(),
            paws_domain::MessageEntry {
                message: ContextMessage::Text(paws_domain::TextMessage {
                    role: Role::Assistant,
                ...
                usage: Some(Usage {
                    prompt_tokens: paws_domain::TokenCount::Actual(100),
                    completion_tokens: paws_domain::TokenCount::Actual(50),
                    total_tokens: paws_domain::TokenCount::Actual(150),
                    cached_tokens: paws_domain::TokenCount::Actual(0),
                    cost: Some(0.001),
                }),
            },
        ];
        ...
        let fixture = Context::default()
            ...
            .temperature(paws_domain::Temperature::new(0.7).unwrap())
            .top_p(paws_domain::TopP::new(0.9).unwrap())
            .top_k(paws_domain::TopK::new(50).unwrap())
