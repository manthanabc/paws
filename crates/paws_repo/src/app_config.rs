...
use paws_domain::{AppConfig, AppConfigRepository, ModelId, ProviderId};
    ...
    async fn read(&self) -> AppConfig {
        ...
        serde_json::from_str::<AppConfig>(&content)
            .or_else(|_| {
                ...
                paws_common::json_repair::json_repair::<AppConfig>(&content).inspect(|_| {
...
mod tests {
    ...
    use bytes::Bytes;
    use paws_app::{EnvironmentInfra, FileReaderInfra, FileWriterInfra};
    use paws_domain::{AppConfig, Environment, ProviderId};
