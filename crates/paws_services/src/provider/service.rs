...
impl<I: EnvironmentInfra + HttpInfra> PawsProviderService<I> {
    ...
    for PawsProviderService<I>
{
    ...
    async fn upsert_credential(&self, credential: paws_domain::AuthCredential) -> Result<()> {
