...
use paws_app::{FileInfoInfra, FileReaderInfra, FsUndoOutput, FsUndoService};
...
impl<F: FileInfoInfra + FileReaderInfra + SnapshotRepository> FsUndoService for PawsFsUndo<F> {
