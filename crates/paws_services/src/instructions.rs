...
use paws_app::{CommandInfra, CustomInstructionsService, EnvironmentInfra, FileReaderInfra};
...
#[derive(Clone)]
pub struct PawsCustomInstructionsService<F> {
    infra: Arc<F>,
    cache: tokio::sync::OnceCell<Vec<String>>,
}

impl<F: EnvironmentInfra + FileReaderInfra + CommandInfra> PawsCustomInstructionsService<F> {
...
impl<F: EnvironmentInfra + FileReaderInfra + CommandInfra> CustomInstructionsService
    for PawsCustomInstructionsService<F>
{
